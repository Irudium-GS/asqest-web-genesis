...
import { Zap, Power, Shield, Wrench, CheckCircle, ArrowRight } from "lucide-react";
...
const ElectricalMaintenance = () => {
  const services = [
    ...
    {
      title: "Installations",
      description: "Professional electrical installations including wiring, outlets, and fixtures.",
      icon: Power
    },
    {
      title: "Safety Inspections",
      description: "Comprehensive electrical safety inspections to ensure code compliance.",
      icon: Shield
    },
    {
      title: "Emergency Services",
      description: "24/7 emergency electrical services for urgent electrical issues.",
      icon: Zap
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Electrical <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Maintenance</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Comprehensive electrical services including repairs, installations, and maintenance for residential and commercial properties. Our certified electricians ensure safe and reliable electrical systems.
              </p>
              <p className="text-gray-300 leading-relaxed">
                From routine maintenance to complex installations, we provide expert electrical services that meet all safety standards and building codes, ensuring your property's electrical systems operate safely and efficiently.
              </p>
            </div>
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-lg backdrop-blur-sm border border-cyan-500/30 flex items-center justify-center transform hover:scale-105 transition-transform duration-500">
                <Zap className="h-32 w-32 text-cyan-400 animate-pulse" />
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-600/20 rounded-2xl p-8 backdrop-blur-sm border border-cyan-500/30">
              ...
              <p className="text-gray-300 text-lg mb-8">
                Contact us today for professional electrical maintenance and installation services.
              </p>
