        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Painting & <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Decorating</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional painting and decorating services to transform your space
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Professional painting and decorating services to transform your space with high-quality finishes and expert craftsmanship. Our skilled painters deliver exceptional results for residential and commercial properties.
              </p>
              <p className="text-gray-300 leading-relaxed">
                From color consultation to final finishing touches, we provide comprehensive painting services that enhance the beauty and value of your property while using premium materials and proven techniques.
              </p>
            </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-600/20 rounded-2xl p-8 backdrop-blur-sm border border-cyan-500/30">
              ...
              <p className="text-gray-300 text-lg mb-8">
                Contact us today for professional painting and decorating services.
              </p>
